...
export exptname="C${RES}_hybcov_hourly_amv"
...
export python=/work/noaa/gsienkf/whitaker/miniconda3/bin/python
...
export execdir=${enkfscripts}/exec_hercules
export gsiexec=${execdir}/global_gsi2
...
export CONVINFO=${enkfscripts}/global_convinfo.txt_nothin
...
export analdate=2021090612
export nitermax=1
while [ $analdate -le 2021090612 ]; do
